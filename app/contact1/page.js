...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={22} footerStyle={5} breadcrumbTitle="Contact ">
        <div>
          <Conatact2 />
                  ...
                  <div className="contcat5-textarea5">
                    ...
                    <div className="phone7-textarea margin-t contactinnerbg">
                      ...
                      <div className="phone7-text">
                        ...
                        <Link
                          href="/mailto:Consult@hotmail.com"
                          className="font-lora font-24 weight-700 lineh-24 color-29"
                        >
                          Consult@hotmail.com
                        </Link>
                  ...
                  <div className="contact5-main-section">
                    <div className="contact-main-text">
                      ...
                      <p className="font-ks font-16 lineh-26 weight-500 color margin-t">
                        As a fellow small business owner, we know the
                        fulfillment that an a comes from running your own
                        business contact to Financy.
                      </p>
                    </div>
