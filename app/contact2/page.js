...
export default function Home() {
  ...
  return (
    <>
      <Layout headerStyle={22} footerStyle={5} breadcrumbTitle="Contact Us">
        <div>
                      ...
                      <div className="col-lg-6">
                        <div className="contact2-maincontact">
                          ...
                          <p className="font-16 font-ks lineh-26 weight-500 color-30 margin-b24">
                            Our response time is within 30 minutes during
                            business hours
                          </p>
                      ...
                      <div className="col-lg-6">
                        ...
                        <div className="contact-padding margin-t">
                          <div className="contact2-auhtor-section contacblogbg contacrtblogbg">
                            <div className="clock-area">
                              <img
                                src="assets/images/icons/phone4.svg"
                                alt=""
                              />
                            </div>
                            <div className="contact-location">
                              <h1 className="font-20 font-lora lineh-24 color weight-600 margin-b">
                                Call or text
                              </h1>
                        ...
                        <div className="contact-padding margin-t ">
                          <div className="contact2-auhtor-section contacrtblogbg">
                            <div className="clock-area">
                              <img
                                src="assets/images/icons/email3.svg"
                                alt=""
                              />
                            </div>
                            <div className="contact-location">
                    ...
                    <div className="mapouter">
                      <div className="gmap_canvas">
                        <iframe
                          ...
                          src="https://maps.google.com/maps?width=1598&amp;height=673&amp;hl=en&amp;q=University of Oxford&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                        ></iframe>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            >
                              <div className="accordion-body">
                                <p className="font-ks font-16 lineh-26 weight-500 color-22 ">
                                  Our consulting process involves four key
                                  steps: Discovery, Strategy, Implementation,
                                  and Sustainment. We start by understanding
                                  your challenges and goals, then craft a
                                  customized strategy.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="accordion-item m-0 bordernone">
                            ...
                            >
                              ...
                              >
                                What sets your consulting firm apart from
                                others?
                              </button>
                            </h2>
                            <div
                            ...
                            <div className="accordion accordian4">
                              <div className="accordion-item bordernone">
                                ...
                                >
                                  ...
                                  >
                                    What can I expect during an initial
                                    consultation?
                                  </button>
                                </h2>
                                <div
                                ...
                                >
                                  <div className="accordion-body">
                                    <p className="font-ks font-16 lineh-26 weight-500 color-22 ">
                                      Yes, we offer expertise in talent
                                      acquisition and team building to your
                                      strategies. We understand that a strong
                                      team is essential for business success and
                                      can provide guidance on hiring the right
                                      talent{" "}
                                    </p>
                                  </div>
                                </div>
                              ...
                              <div className="accordion-item bordernone">
                                ...
                                >
                                  ...
                                  >
                                    Consulting services help with crisis
                                    management?
                                  </button>
                                </h2>
                                <div
                              ...
                              <div className="accordion-item m-0 bordernone">
                                ...
                                >
                                  ...
                                  >
                                    Data and analytics play your consulting
                                    approach?
                                  </button>
                                </h2>
                                <div
