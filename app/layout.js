import { Kumbh_Sans, Lora, Nunito, Outfit } from "next/font/google";
...
export const metadata = {
  title: "farpod",
  description: "Fairytale Agency for Research and Policy Development Limited",
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body
        className={`${nunito.variable} ${outfit.variable} ${kumbh.variable} ${lora.variable}`}
      >
        {children}
      </body>
    </html>
