            ...
            <div className="col-lg-12">
                  ...
                  <div className="col-lg-3">
                    <div className="contact5-logo5-text">
                      ...
                      <p className="font-ks font-16 weight-500 lineh-26 color32 margin-t margin-b24">
                        Include FARPoD was formed with mission as consultant
                        firm that will offer several services ranging from
                        strategy to problem-solving, Planning, Analytics, M&E,
                        Customer and Marketing, Core Business Operations, Human
                        Capital, Enterprise, Technology and Performance.
                      </p>
                      ...
                      <div className="contact6-ctafrom">
                        ...
                        <form>
                          ...
                          <div className="contact5-btn15">
                            <button
                              className="font-ks font-16 lineh-16 weight-700 color contcat6"
                              type="submit"
                            >
                              Submit Now{" "}
                              <span>
              ...
              <div className="copyright6 text-center">
                <p className="font-ks lineh-26 weight-500 font-16 color32">
                  © Copyright {new Date().getFullYear()} Consalt Law Consultant,
                  Designed by Fleexstudio
                </p>
              </div>
            </div>
          </div>
