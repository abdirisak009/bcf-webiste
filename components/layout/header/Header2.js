                            ...
                            <div className="col-12">
                                <div className="header-elements">
                                    <div className="site-logo">
                                        <Link href="/index1"><img src="/assets/images/logo/flogo.png" alt="" /></Link>
                                    </div>
                                    <div className="main-menu-ex homepage5 mainmenuex">
                                        <ul>
                                                ...
                                                <ul className="dropdown-padding">
                                                    ...
                                                    <li><Link href="/about" className="font-outfit font-16 weight-500 color">Service Details <i className="fa-solid fa-angle-right" /></Link>
                                                        <ul>
                                                            ...
                                                            <li><Link href="/servicemiddle" className="font-outfit font-16 weight-500 color-1">Service
                                                                Single</Link></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li><Link href="#" className="font-outfit font-18 weight-500 color-1">Pages <span><i className="fa-solid fa-angle-down" /></span></Link>
                                                <ul>
                                                    <li><Link href="/testimonials" className="font-outfit font-18 weight-500 color-1">Testimonials</Link></li>
                                    ...
                                    <div className="contact-3 d-lg-block d-none">
                                        <div className="all-3-btn theme-btn1">
                                            <div className="theme-btn-2">
                                                ...
                                                <Link href="/tel:123-456-7890" className="font-outfit font-18 lineh-18 weight-600 color-17">123-456-7890</Link>
                                            </div>
