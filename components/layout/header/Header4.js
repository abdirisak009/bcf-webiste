                            ...
                            <div className="col-12">
                                <div className="header-elements">
                                    <div className="site-logo">
                                        <Link href="/index1"><img src="/assets/images/logo/" alt="" /></Link>
                                    </div>
                                    <div className="main-menu-ex homepage3 homepage5">
                                        <ul>
                                            <li className="mega-dropdawn"><Link href="#" className="font-nunito weight-600">Home <i className="fa-solid fa-angle-down" /></Link>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index1" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index1" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index7" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index2" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index3" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index3" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index8" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index4" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index2" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index5" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index5" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index6" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index4" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index7" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index6" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index8" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index9" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index9" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index10" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index10" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index11" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index11" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="col-lg-3">
                                                                ...
                                                                <div className="mega-menu-item-box">
                                                                    ...
                                                                    <div className="mega-menu-items-button mega-menu-items-button6">
                                                                        <Link href="/index12" className="theme-btn11 font-f-3 consultingbtn6"><span className="font-nunito font-16 lineh-16 weight-600 color">Multipage
                                                                            <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                        <Link href="/single-index12" className="theme-btn11 font-f-3 consultingbtn6 d-inline-block margin-t"><span className="font-nunito font-16 lineh-16 weight-600 color">Landing
                                                                            Page <span><i className="fa-solid fa-arrow-right" /></span></span></Link>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div className="theme-btn-3">
                                                ...
                                                <div className="phonr6-area">
                                                    <p className="font-16 lineh-16 color-25 weight-400 font-nunito margin-b8">Free
                                                        Consultation</p>
                                                    <Link href="/tel:123-456-7890" className="font-nunito font-18 lineh-18 weight-600 color-25">123-456-7890</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
